...
var orm = {
    ...
    member: function(res, render) {
        var queryString = 'INSERT INTO members (MemberName, EmailAddress, TwitterHandle, BloodType) VALUES (?, ?, ?, ?)', [req.body.MemberName, req.body.EmailAddress, req.body.TwitterHandle, req.body.BloodType], connection.query(queryString, function(err, result) {
                if (err) throw err;
                console.log(result);
                res.redirect('/');
            });
